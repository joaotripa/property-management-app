---
title: "Domari: A Simple Rental Property Tracker for Landlords and Investors"
excerpt: "Tired of spreadsheets? Domari is a simple rental property tracker that helps landlords and investors monitor income, expenses, and ROI effortlessly."
...
That’s how **Domari** came to life: a simple web app that helps landlords and property investors track rental income, expenses, and cash flow for all their properties in one organized place.

<Image
  src="/blog-images/dashboard-overview-page.png"
  alt="Domari dashboard overview showing portfolio insights"
  caption="The Domari dashboard gives a clear overview of your rental portfolio at a glance."
/>
