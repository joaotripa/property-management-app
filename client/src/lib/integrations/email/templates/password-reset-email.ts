...
export function getPasswordResetEmailTemplate({ resetCode }: PasswordResetEmailProps): string {
  ...
  return `
    ...
    <head>
      ...
      <title>Password Reset Code - Domari</title>
    </head>
              ...
              <tr>
                <td style="padding: 40px 32px;">
                  <div style="text-align: center; margin-bottom: 30px;">
                    <h2 style="color: #1E293B; font-size: 24px; margin: 0 0 10px 0; font-weight: 600;">Reset password code</h2>
                  ...
                  <div style="background: #F1F5F9; border-radius: 8px; padding: 20px; margin: 30px 0; border: 1px solid #E2E8F0;">
                    <p style="color: #64748B; font-size: 14px; margin: 0; line-height: 1.5;">
                      <strong style="color: #1E293B;">Security notice:</strong> If you didn't request a password reset, please contact our support@domari.app for further investigation. Your security is important to us.
                    </p>
                  </div>
                </td>
              </tr>
