...
export function ROIChart({ data = [], timeRange = "semester" }: ROIChartProps) {
    ...
    <Card className="min-h-0">
      <CardHeader className="pb-3 sm:pb-4 md:pb-5">
        <div className="flex items-center justify-between">
          <CardTitle className="flex items-center text-lg sm:text-xl md:text-2xl">ROI Performance</CardTitle>
        </div>
      </CardHeader>
          ...
          <ChartContainer config={chartConfig} className="h-[240px] sm:h-[280px] md:h-[320px] lg:h-[360px] xl:h-[400px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Bar dataKey="roi" radius={8} barSize={40} />
              </BarChart>
            </ResponsiveContainer>
          </ChartContainer>
        )}
